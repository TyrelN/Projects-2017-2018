...
public class Board extends JPanel implements KeyListener {
	...
	public Board() {
		...
		shapes[0] = new Shape(blocks.getSubimage(0, 0, blockSize, blockSize), new int[][] { { 1, 1, 1, 1 } // IShape
		}, this, 1);

		shapes[1] = new Shape(blocks.getSubimage(blockSize, 0, blockSize, blockSize),
				new int[][] { { 1, 1, 0 }, { 0, 1, 1 } // ZShape
				}, this, 2);
	...
	public void keyReleased(KeyEvent e) { // releasing the down key should slow
											// the block back down to normal
											// speed
		if (e.getKeyCode() == KeyEvent.VK_DOWN) {
